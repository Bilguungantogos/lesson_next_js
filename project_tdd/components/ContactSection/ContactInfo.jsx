...
const ContactInfo = () => {
  return (
    <div className="container my-[100px] flex flex-col items-center mx-auto ">
      <div className="md:w-[624px] max-md:mx-[50px]">
      ...
      <div className="max-md:flex-col flex py-4 gap-[50px] md:w-[624px]">
        <div className="p-4 rounded-[10px] border-slate-300 border-2 max-md:w-[250px] w-[50%] h-[133px]">
